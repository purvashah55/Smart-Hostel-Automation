...
<div id="background">
		<div id="page">
			...
			<div>
				...
				<h1 style="color: #316e66;font: 30px/30px ">Hostel LogIn</h1> 
				<p> 
					UserName 
					<input required="required" type="text" placeholder="username" name="adminUserName"/>
				</p>
				<p> 
					Password 
					<input required="required" type="password" placeholder="eg. X8df!90EO" name="adminPassword"/> 
				</p>
				<p> 
				...
				<p>
					Not a member yet ? 
					<a href=>Contact us to be member of this forum</a>
				</p>
			</form>
			</div>
			</div>	
